  ...
  test.predictions = list("OLS" = lm.pred, "Ridge" = ridge.pred,
                          ...
                          "GBRT" = boost.pred, "NN1"=NN1.pred, "NN2"=NN2.pred, "NN3"=NN3.pred)
  DB.grid = c("OLS" = 1, "Ridge" = 2,
              "Lasso" = 3, "ENET" = 4, "PCR"=5,
              "PLSR"=6, "GLM" = 7, "RandomF" = 8,
              "GBRT" = 9, "NN1"=10, "NN2"=11, "NN3" = 12) %>% expand.grid(.,.)
...
return(list("OLS"=c("R2-OOS"=lm.R2, "R2-IS"=lm.R2.IS, "MSE-OOS"=lm.mse, "MSE-IS"=lm.mse.IS), 
              ...
              "models" = list("OLS"=lm.list, "ridge" = ridge.list, "lasso" = lasso.list, "enet" = enet.list,
...
save(output, file = "data_output.RData")
